  ...
  return (
    <div className={`relative overflow-hidden bg-paper-deep ${className}`}>
      ...
      <div className="absolute inset-0 flex items-center justify-center p-5">
        <div className="flex aspect-[1.58/1] w-[82%] max-w-[360px] flex-col justify-between rounded-lg border border-white/40 bg-surface p-4 shadow-[0_10px_26px_-16px_rgba(20,21,28,0.5)] sm:p-5">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="u-label text-ink-3">Gift card</p>
              <p className="u-display mt-2 text-[1.05rem] leading-tight text-ink sm:text-[1.25rem]">{brand.name}</p>
            </div>
