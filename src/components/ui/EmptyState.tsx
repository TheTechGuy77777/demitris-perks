...
export function EmptyState({
  ...
  const action = actionLabel && (
    <span className="mt-6 inline-flex min-h-11 items-center justify-center rounded-md bg-primary px-5 py-2.5 text-[0.9375rem] font-semibold text-white transition-colors hover:bg-primary-hover">
      {actionLabel}
    </span>
  );
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 max-w-[42ch] text-[0.9rem] leading-relaxed text-ink-3">{body}</p>
